...
var $author$project$Model$PostsConfig$applyChanges = F2(
	function (a, b) {
		switch (a.$) {
			case 'PostsToFetch':
				var x = a.a;
				return A5($author$project$Model$PostsConfig$PostsConfig, x, b.postsToShow, b.sortBy, b.showJobs, b.showTextOnly);
			case 'PostsToShow':
				var x = a.a;
				return A5($author$project$Model$PostsConfig$PostsConfig, b.postsToFetch, x, b.sortBy, b.showJobs, b.showTextOnly);
			case 'Sort':
				var x = a.a;
				return A5($author$project$Model$PostsConfig$PostsConfig, b.postsToFetch, b.postsToShow, x, b.showJobs, b.showTextOnly);
			case 'ShowJobs':
				var x = a.a;
				return A5($author$project$Model$PostsConfig$PostsConfig, b.postsToFetch, b.postsToShow, b.sortBy, x, b.showTextOnly);
			default:
				var x = a.a;
				return A5($author$project$Model$PostsConfig$PostsConfig, b.postsToFetch, b.postsToShow, b.sortBy, b.showJobs, x);
		}
	});
var $author$project$Main$helpState = F2(
	function (a, b) {
		return A2($author$project$Model$PostsConfig$applyChanges, b, a);
	});
...
var $author$project$Main$uhelpr = F4(
	function (model, result, config, time) {
		if (result.$ === 'Ok') {
			if (result.a.$ === 'Just') {
				var ids = result.a.a;
				var nextId = $author$project$Model$PostIds$first(ids);
				return _Utils_Tuple2(
					$author$project$Model$LoadingPosts(
						{config: config, currentId: nextId, postIds: ids, posts: _List_Nil, time: time}),
					A2($author$project$Main$getPost, model.config.apiUrl, nextId));
			} else {
				var _v1 = result.a;
				return _Utils_Tuple2(
...
var $author$project$Model$PostIds$advance = function (_v0) {
	var ids = _v0.a;
	var a = $author$project$Cursor$forward(ids);
	if (a.$ === 'Nothing') {
		return $elm$core$Maybe$Nothing;
	} else {
		var x = a.a;
		return $elm$core$Maybe$Just(
			_Utils_Tuple2(
				$author$project$Cursor$current(x),
				$author$project$Model$PostIds$PostIds(x)));
	}
};
var $author$project$Main$uhelpr2 = F3(
	function (model, result, loading) {
		if (result.$ === 'Ok') {
			var post = result.a;
			var _v1 = $author$project$Model$PostIds$advance(loading.postIds);
			if (_v1.$ === 'Just') {
				var _v2 = _v1.a;
				var nextId = _v2.a;
				var nextPostIds = _v2.b;
				var posts = A2($elm$core$List$cons, post, loading.posts);
				return (_Utils_cmp(
					$elm$core$List$length(posts),
					loading.config.postsToFetch) > -1) ? _Utils_Tuple2(
...
var $author$project$Main$uhelper = F2(
	function (msg, model) {
		...
		while (true) {
			switch (_v0.b.$) {
				...
				case 'GotPostIds':
					if (_v0.a.$ === 'Loading') {
						var config = _v0.a.a.config;
						var time = _v0.a.a.time;
						var result = _v0.b.a;
						return A4($author$project$Main$uhelpr, model, result, config, time);
					} else {
						break _v0$4;
					}
				case 'GotPost':
					if (_v0.a.$ === 'LoadingPosts') {
						var loading = _v0.a.a;
						var result = _v0.b.a;
						return A3($author$project$Main$uhelpr2, model, result, loading);
					} else {
						break _v0$4;
					}
				default:
					if (_v0.a.$ === 'LoadedPosts') {
						var state = _v0.a.a;
						var x = _v0.b.a;
						return _Utils_Tuple2(
							$author$project$Model$LoadedPosts(
								{
									config: A2($author$project$Main$helpState, state.config, x),
									posts: state.posts,
									time: state.time
								}),
							$author$project$Effect$NoEffect);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var _v0 = A2($author$project$Main$uhelper, msg, model);
		var newState = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Util$Time$toDays = F2(
	function (a, b) {
		return A2($elm$time$Time$toDay, $elm$time$Time$utc, a) - A2($elm$time$Time$toDay, $elm$time$Time$utc, b);
	});
...
var $author$project$Util$Time$toHours = F2(
	function (a, b) {
		return A2($elm$time$Time$toHour, $elm$time$Time$utc, a) - A2($elm$time$Time$toHour, $elm$time$Time$utc, b);
	});
...
var $author$project$Util$Time$toMins = F2(
	function (a, b) {
		return A2($elm$time$Time$toMinute, $elm$time$Time$utc, a) - A2($elm$time$Time$toMinute, $elm$time$Time$utc, b);
	});
...
var $author$project$Util$Time$toSecs = F2(
	function (a, b) {
		return A2($elm$time$Time$toSecond, $elm$time$Time$utc, a) - A2($elm$time$Time$toSecond, $elm$time$Time$utc, b);
	});
var $author$project$Util$Time$durFunc = F2(
	function (a, b) {
		var z = A2($author$project$Util$Time$toDays, a, b);
		var y = A2($author$project$Util$Time$toMins, a, b);
		var x = A2($author$project$Util$Time$toSecs, a, b);
		var w = A2($author$project$Util$Time$toHours, a, b);
		...
		if ((((((((_v0.b && (!_v0.a)) && _v0.b.b) && (!_v0.b.a)) && _v0.b.b.b) && (!_v0.b.b.a)) && _v0.b.b.b.b) && (!_v0.b.b.b.a)) && (!_v0.b.b.b.b.b)) {
			...
			return $elm$core$Maybe$Just(
				A4($author$project$Util$Time$Duration, x, y, w, z));
		}
	});
var $author$project$Util$Time$durationBetween = F2(
	function (a, b) {
		return (_Utils_cmp(
			...
			$elm$time$Time$posixToMillis(b)) > 0) ? $elm$core$Maybe$Nothing : A2($author$project$Util$Time$durFunc, b, a);
	});
var $author$project$Util$Time$emptyZero = F2(
	function (a, b) {
		return (b === 1) ? ($elm$core$String$fromInt(b) + (a + ' ')) : ((!(!b)) ? ($elm$core$String$fromInt(b) + (a + 's ')) : '');
	});
var $author$project$Util$Time$formatDuration = function (dur) {
	...
	var hours = _v0.hours;
	var days = _v0.days;
	var dayz = A2($author$project$Util$Time$emptyZero, ' day', days);
	var hourz = A2($author$project$Util$Time$emptyZero, ' hour', hours);
	var minz = A2($author$project$Util$Time$emptyZero, ' minute', minutes);
	var secz = A2($author$project$Util$Time$emptyZero, ' second', seconds);
	return dayz + (hourz + (minz + (secz + 'ago')));
};
var $elm$html$Html$td = _VirtualDom_node('td');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $elm$html$Html$tr = _VirtualDom_node('tr');
var $author$project$View$Posts$renderPost = F2(
					...
					_List_fromArray(
						[
							...
							$author$project$Util$Time$formatDuration(
								A2(
									$elm$core$Maybe$withDefault,
									A4($author$project$Util$Time$Duration, 0, 0, 0, 0),
									A2(
										$author$project$Util$Time$durationBetween,
										$elm$time$Time$millisToPosix(1701716172),
										post.time))))
						])),
					A2(
					$elm$html$Html$td,
...
var $author$project$View$Posts$renderPosts = F2(
	function (config, posts) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$View$Posts$renderPost(config),
				posts));
	});
var $elm$html$Html$th = _VirtualDom_node('th');
var $author$project$View$Posts$postTable = F3(
	function (config, timestamp, posts) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					A2($author$project$View$Posts$renderPosts, config, posts)
				]));
	});
...
var $author$project$Model$PostsConfig$PostsToShow = function (a) {
	return {$: 'PostsToShow', a: a};
};
var $author$project$Model$PostsConfig$Score = {$: 'Score'};
var $author$project$Model$PostsConfig$ShowJobs = function (a) {
	return {$: 'ShowJobs', a: a};
};
var $author$project$Model$PostsConfig$ShowTextOnly = function (a) {
	return {$: 'ShowTextOnly', a: a};
};
var $author$project$Model$PostsConfig$Sort = function (a) {
	return {$: 'Sort', a: a};
};
...
var $author$project$Model$PostsConfig$sortFromString = function (sort) {
	switch (sort) {
		case 'Score':
			...
			[
							...
							[
								...
								function (_v0) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$ShowJobs(!config.showJobs));
								})
							]),
						_List_Nil),
					...
					[
						...
						_List_fromArray(
							[
								...
								function (_v1) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$ShowTextOnly(!config.showTextOnly));
								})
							]),
						_List_Nil),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$attribute, 'id', 'select-posts-per-page'),
								$elm$html$Html$Events$onInput(
								function (x) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$PostsToShow(
											A2(
												$elm$core$Maybe$withDefault,
												10,
												$elm$core$String$toInt(x))));
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$attribute, 'id', 'select-sort-by'),
								$elm$html$Html$Events$onInput(
								function (x) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$Sort(
											A2(
												$elm$core$Maybe$withDefault,
...
var $author$project$MyTest$checkConfigChangeEffect = F4(
...
var $author$project$MyTest$check = A4(
	$author$project$MyTest$checkConfigChangeEffect,
	_List_fromArray(
		[
	...
	if (!a.b) {
		...
		return $elm$core$Maybe$Just(
			A3(
				...
				xs,
				x,
				A2($elm$core$List$cons, b, c)));
	}
};
var $author$project$Cursor$count = function (l) {
	var cunt = F2(
		function (lis, acc) {
			cunt:
			while (true) {
...
var $author$project$Cursor$aCurs = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var c = _v0.c;
	return a;
};
var $author$project$Cursor$bCurs = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var c = _v0.c;
	return b;
};
var $author$project$Cursor$cCurs = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var c = _v0.c;
	return c;
};
var $author$project$Cursor$reverse = function (l) {
	var reverseAcc = F2(
		function (lx, acc) {
			reverseAcc:
			while (true) {
...
var $author$project$Cursor$toList = function (a) {
	return _Utils_ap(
		$author$project$Cursor$reverse(
			A2(
				$elm$core$List$cons,
				$author$project$Cursor$bCurs(a),
				$author$project$Cursor$aCurs(a))),
		$author$project$Cursor$cCurs(a));
};
var $author$project$Cursor$length = function (a) {
	return $author$project$Cursor$count(
		$author$project$Cursor$toList(a));
};
...
var $author$project$Model$PostsConfig$fhelp = F2(
	function (l, acc) {
		fhelp:
		while (true) {
			if (!l.b) {
				...
				if (x.type_ !== 'job') {
					return _Utils_ap(
						A2($author$project$Model$PostsConfig$fhelp, xs, acc),
						_List_fromArray(
							[x]));
				} else {
					var $temp$l = xs,
...
var $author$project$Model$PostsConfig$fjobs = F2(
	function (a, b) {
		return (!a.showJobs) ? A2($author$project$Model$PostsConfig$fhelp, b, _List_Nil) : b;
	});
var $author$project$Model$PostsConfig$fhelp2 = F2(
	function (l, acc) {
		fhelp2:
		while (true) {
			if (!l.b) {
				...
				var x = l.a;
				var xs = l.b;
				if (!_Utils_eq(x.url, $elm$core$Maybe$Nothing)) {
					return _Utils_ap(
						A2($author$project$Model$PostsConfig$fhelp2, xs, acc),
						_List_fromArray(
							[x]));
				} else {
					var $temp$l = xs,
...
var $author$project$Model$PostsConfig$furl = F2(
	function (a, b) {
		return (!a.showTextOnly) ? A2($author$project$Model$PostsConfig$fhelp2, b, _List_Nil) : b;
	});
var $author$project$Model$PostsConfig$limit = F2(
	function (l, n) {
		var limhelp = F3(
			function (lis, b, acc) {
				if (!lis.b) {
					...
					var x = lis.a;
					var xs = lis.b;
					return (_Utils_cmp(b, n) < 1) ? _Utils_ap(
						A3(limhelp, xs, b + 1, acc),
						_List_fromArray(
							[x])) : acc;
				}
			});
		return A3(limhelp, l, 1, _List_Nil);
	});
...
var $author$project$Model$PostsConfig$filterPosts = F2(
	function (a, b) {
		return A2(
			...
			$author$project$Model$PostsConfig$sortToCompareFn(a.sortBy),
			$elm$core$List$reverse(
				A2(
					$author$project$Model$PostsConfig$limit,
					A2(
						$author$project$Model$PostsConfig$furl,
						a,
						A2($author$project$Model$PostsConfig$fjobs, a, b)),
					a.postsToShow)));
	});
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/ian/Documents/fp/project/tests/ExampleTests/CursorTests.elm', '/home/ian/Documents/fp/project/tests/ExampleTests/ModelPostIdsTests.elm', '/home/ian/Documents/fp/project/tests/ExampleTests/ModelPostsConfigTests.elm', '/home/ian/Documents/fp/project/tests/ExampleTests/UtilTimeTests.elm', '/home/ian/Documents/fp/project/tests/MainTests.elm', '/home/ian/Documents/fp/project/tests/MyTest.elm', '/home/ian/Documents/fp/project/tests/PostsConfigTests.elm', '/home/ian/Documents/fp/project/tests/PostsViewTests.elm', '/home/ian/Documents/fp/project/tests/PostTests.elm', '/home/ian/Documents/fp/project/tests/SimulatedEffect.elm', '/home/ian/Documents/fp/project/tests/TestData.elm', '/home/ian/Documents/fp/project/tests/TestUtils.elm']),
		processes: 12,
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$MyTest$check)
				])),
			_Utils_Tuple2(
			'PostsConfigTests',
			_List_fromArray(
...
var pipeFilename = "/tmp/elm_test-8123.sock";
var net = require('net'),
